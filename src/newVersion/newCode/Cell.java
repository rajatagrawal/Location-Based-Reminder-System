...
/**
 * This class is used to draw the cell that are used to compose the cell of the month view of the calendar that the 
 * user uses to select a date for his reminder.
 * @author RajatHCI
 *
 */
public class Cell {
